...
## 测试命令：
python IMHI.py --model_path ../../Mixtral-8x7B-v0.1/ --adapter_path ../../Mixtral-8x7B-lora/checkpoint-320 --batch_size 8 --model_output_path ../model_output --test_dataset IMHI-completion IMHI --cuda
